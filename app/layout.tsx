        ...
        <nav className="w-full bg-white shadow-md p-4 border-b border-gray-300 fixed top-0 left-0 right-0 z-50">
          <div className="max-w-[90%] mx-auto flex justify-between items-center">
            ...
            <div className="text-lg flex items-center gap-x-4 font-medium">
              <Link href="/" className="text-gray-700 hover:text-primary mr-4">Home</Link>
              <Link href="#" className="text-gray-700 hover:text-primary mr-4">Features</Link>
              <Link href="#" className="text-gray-700 hover:text-primary mr-4">Pricing</Link>
              <Link href="/login" className="text-gray-700 hover:text-primary mr-4">Login</Link>
              <Link href="/get-started" className="px-4 py-[5px] cursor-pointer bg-primary rounded-lg inline-flex justify-center items-center gap-2.5">
